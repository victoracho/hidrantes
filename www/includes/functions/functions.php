...
241=>'ntilde'
	...
	*/
	...
	if ($carta_id<=0){
		...
		$datos_carta_n=$bd->get_all_by_id("cartas","carta_id",$carta_id);
		var_dump($datos_carta_n);
		$ncartas=$datos_carta_n["interno"];
	}
...
//Atentamente
   // $pdf->ezText("\n\n",11);   
	...
	$pdf->ezSetMargins(0,10,30,40);
$pdf->ezImage(imgadminpath."footer.jpg",50,450,'none','left');
$pdf->ezSetDy(10);
/*$pdf->ezImage(imgadminpath."logogris.jpg",-70,180,'none','center');
$pdf->ezSetDy(120); 
$pdf->ezImage(imgadminpath."ce.jpg",60,80,'none','right');
*/
//$pdf->ezSetDy(100);
//$pdf->ezSetDy(30);
